...
If you're using Tool Router + MCP and have large tool surfaces, use the experimental **Smart MCP Tool Exposure** session option to add adaptive discovery filtering while keeping execution/auth routing unchanged.
